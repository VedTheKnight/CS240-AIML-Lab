...
class  NaiveBayes:
	...
	def _calc_class_prior(self):
		...
		for outcome in self.y_train:
			### YOUR CODE BEGINS HERE ###

			#TODO_1
			
			self.class_priors[outcome] += 1 #TODO_2    Remove 0 and write your code 

		for outcome in np.unique(self.y_train):
			self.class_priors[outcome] = self.class_priors[outcome] / self.train_size
	...
	def predict(self, X):
		...
		for query in X:
			...
			for outcome in np.unique(self.y_train):
				...
				posterior = likelihood * self.class_priors[outcome] / evidence #TODO_2         Remove 0 and get posterior
